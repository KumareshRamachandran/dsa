...
{
	long double k; cin >> k;
	long double ad = (long double) round(sqrt(k * 1.0));
	long double ans = k + ad;
...
{
#ifndef ONLINE_JUDGE
	freopen("C:/Users/kumar/OneDrive/Desktop/DSA_-_CP/input.txt", "r", stdin);
	freopen("C:/Users/kumar/OneDrive/Desktop/DSA_-_CP/output.txt", "w", stdout);
	freopen("C:/Users/kumar/OneDrive/Desktop/DSA_-_CP/error.txt", "w", stderr);
#endif
	fastio();
	int t = 1;
	cin >> t;
